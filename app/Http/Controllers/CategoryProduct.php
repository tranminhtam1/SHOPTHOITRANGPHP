...
class CategoryProduct extends Controller
{
    ...
    {   
        ...
        Session::put('message','khong kich hoat danh muc sp thanh cong');
    ...
    {   
        ...
        Session::put('message',' kich hoat danh muc sp thanh cong');
        return Redirect::to ('all-category-product');
    }
    ...
    {   
        ...
        $manager_category_product = view ('admin.edit_category_product')->with ('edit_category_product',
