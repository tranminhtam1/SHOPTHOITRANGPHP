...
class ProductController extends Controller
{
     ...
     public function save_product(Request $request)
    {
        ...
        if($get_image){
            ...
            $mame_image = current(explode('.',$get_name_image));
    ...
    {   
        ...
        Session::put('message','khong kich hoat  sp thanh cong');
    ...
    {   
        ...
        Session::put('message',' kich hoat sp thanh cong');
        return Redirect::to ('all-product');
    }
    ...
    {   
        ...
        $manager_product = view ('admin.edit_product')->with ('edit_product',
        $edit_product)->with ('cate_product',
        $cate_product)->with ('brand_product',
        $brand_product);
    ...
    public function delete_product($product_id){
        ...
        Session::put('message',' xoa sp thanh cong');
        return Redirect::to ('all-product');
    }
